...
import com.ogc.common.tool.Reflection;
...
public class ImportExcel {
	...
	public ImportExcel(String fileName, InputStream is, int headerNum, int sheetIndex) 
		...
		if (StringUtils.isBlank(fileName)){
        	...
        	throw new RuntimeException("Document format is invalid");
        }  
		if (this.wb.getNumberOfSheets()<sheetIndex){
			throw new RuntimeException("No sheet in document");
		}
	 ...
	 * @param groups 导入分组
	 */
	public <E> List<E> getData(Class<E> cls, int... groups) throws InstantiationException, IllegalAccessException{
...
//					}
//				}else{
					annotationList.add(new Object[]{ef, f, column});
//				}
			}
			column++;
		}
...
//					}
//				}else{
					annotationList.add(new Object[]{ef, m, ef.sort()});
				}
			}
			column++;
		}
