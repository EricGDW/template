...
public class HttpClientUtil {
	...
	public static String postJsonBody(String url, int timeout, 
		...
		try {
		    ...
		    String str1 = JsonUtil.object2JsonStr(map).replace("\\", "");
	...
	public static String invokeGet(String url, Map<String, String> params, 
		...
		try {
			...
			logger.info(String.format("[HttpUtils Get]Debug url:%s , "
					+ "response string %s:", sb.toString(), responseString));
		} catch (SocketTimeoutException e) {
			logger.error(String.format("[HttpUtils Get]invoke get timout error,"
					+ "url:%s", sb.toString()), e);
			return responseString;
		} catch (Exception e) {
	...
	public static String connectPostHttps(String reqURL, 
		...
		try {
			...
			logger.info("requestURI : "+httpPost.getURI()+", responseContent: " 
					+ responseContent);
